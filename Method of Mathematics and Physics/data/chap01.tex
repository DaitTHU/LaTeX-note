...
\begin{example}{热传导}{heat conduction}
	...
	\[
		Q=\int_{t_1}^{t_2}\oint_{\p\Omega}k\pv u{\bm n}\d S\d t=\int_{t_1}^{t_2}\int_\Omega k\lapla u\d V\d t,
	\]
	...
	%$c$ - 比热，$\rho$ - 密度，$k$ - 热传导系数\\
	\begin{align}
		\pv ut=a^2\lapla u,\quad a^2:=\frac k{c\rho}.
	\end{align}
\end{example}
\iffalse
...
\begin{example}{中心对称球面波}{}
	...
	\[
		\lapla=\frac1{r^2}\pp r\kh{r^2\pp r}+\frac1{r^2\sin\theta}\pp \theta\kh{\sin\theta\pp \theta}+\frac1{r^2\sin^2\theta}\pp[2]\phi.
	\]
	波动方程变为
	\[
