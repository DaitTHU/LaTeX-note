...
\begin{center}
	\begin{tikzpicture}[scale=.8]
		...
		\draw[->](0, -2.5)--(0, 2.5)node[left]{$\epsilon_2$};
...
\begin{center}
	\begin{tikzpicture}[scale=1.5]
        ...
        \draw[->, gray, rotate=31.68](-2.5, 0)--(2.5, 0);
...
\begin{theorem}
    ...
    \begin{center}
		...
		\draw[thick, ->-, red](O)--(i)node[midway, below left]{$r_{12}^2$};
		\draw[thick, ->-, red](O)--(tr)node[midway, above left]{$r_{12}t_{12}$};
		\draw[thick, ->-, blue, shift={(.1, 0)}](1.2, -2)--(0, 0)node[midway, above right]{$t_{12}$};
		\draw[thick, ->-, blue, shift={(.1, 0)}](0, 0)--(-2, 2)node[midway, above right]{$t_{12}t_{21}$};
		\draw[thick, ->-, blue, shift={(.1, 0)}](0, 0)--(-1.2, -2)node[midway, below right]{$t_{12}r_{21}$};
        \end{tikzpicture}
