...
细箭头表示$\bm E$终点运动方向，
\begin{center}
	\includegraphics[page=\pagenumref{tikz:linear polarization}]{figures/tikz/layouts.pdf}
...
\begin{center}
    \includegraphics[page=\pagenumref{tikz:circular polarization}]{figures/tikz/layouts.pdf}
...
\begin{center}
	\includegraphics[page=\pagenumref{tikz:elliptical polarization}]{figures/tikz/layouts.pdf}
...
\begin{definition}
    ...
    \begin{subequations}
        \begin{align}
            s_0&=\abs{\uvec\epsilon_1\cdot\bm E}^2+\abs{\uvec\epsilon_2\cdot\bm E}^2=\abs{E_1}^2+\abs{E_2}^2,\\
            s_1&=\abs{\uvec\epsilon_1\cdot\bm E}^2-\abs{\uvec\epsilon_2\cdot\bm E}^2=\abs{E_1}^2-\abs{E_2}^2,\\
    ...
    \begin{subequations}
        \begin{align}
            s_0&=\abs{\uvec\epsilon_+\cj\cdot\bm E}^2+\abs{\uvec\epsilon_-\cj\cdot\bm E}^2=\abs{E_+}^2+\abs{E_-}^2,\\
            ...
            s_3&=\abs{\uvec\epsilon_+\cj\cdot\bm E}^2-\abs{\uvec\epsilon_-\cj\cdot\bm E}^2=\abs{E_+}^2-\abs{E_-}^2.
        \end{align}
    \end{subequations}
\end{definition}
\begin{corollary}
...
\begin{center}
	\includegraphics[page=\pagenumref{tikz:reflection and transmission}]{figures/tikz/layouts.pdf}
...
\begin{theorem}
    ...
    \begin{center}
        \includegraphics[page=\pagenumref{tikz:Stokes relations I}]{figures/tikz/layouts.pdf}
        \includegraphics[page=\pagenumref{tikz:Stokes relations II}]{figures/tikz/layouts.pdf}
...
\begin{figure}[!htp]
    \centering
    \subcaptionbox{垂直极化波}{\includegraphics[page=\pagenumref{tikz:senkrecht polarization}]{figures/tikz/layouts.pdf}}
    \subcaptionbox{平行极化波}{\includegraphics[page=\pagenumref{tikz:parallel polarization}]{figures/tikz/layouts.pdf}}
    \caption{垂直极化波和平行极化波}
...
\[
    \bm S\cdot\uvec n=\frac12\Re[(\bm E\times\bm H\cj)\cdot\uvec n]=\frac1{2\omega\mu'}\Re[(\bm k'\cdot\uvec n)\abs{\bm E'_0}^2]=0.
\]
...
静态电磁场
\[
    D_\alpha=\varepsilon_0E_\alpha+P_\alpha-\sum_\beta\pv{Q'_{\alpha\beta}}{x_\beta}+\cdots
\]
若考虑时间，
会发生什么变化？
