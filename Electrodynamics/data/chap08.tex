...
\begin{align}
    \notag
    \bm A(\bm r,t)&=\frac{\mu_0}{4\pi}\int\frac{\bm J(\bm r',t')}{|\bm r-\bm r'|}\vd\Bigkh{t'-t+\frac{|\bm r-\bm r'|}c}\d t'\nd v'\\
    \label{eqn:A-Jeiwt}
    &=\frac{\mu_0}{4\pi}\int\frac{\bm J(\bm r')}{|\bm r-\bm r'|}\e{\i k|\bm r-\bm r'|}\d V'.
\end{align}
磁场和电场为
\[
