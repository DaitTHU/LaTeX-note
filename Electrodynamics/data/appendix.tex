...
\begin{definition}
    ...
    矢量Laplacian
    \begin{equation}
        \lap\bm A\equiv\lap A_x\uvec x+\lap A_y\uvec y+\lap A_z\uvec z.
    \end{equation}
\end{definition}
...
\begin{theorem}
    ...
    Laplacian的乘法法则
    \begin{align}
        \lap(\psi\phi)&=\psi\lap\phi+2\nabla\psi\cdot\nabla\phi+(\lap\psi)\phi,\\
        \lap(\psi\bm A)&=\psi\lap\bm A+2(\nabla\psi\cdot\nabla)\bm A+(\lap\psi)\bm A,\\
        \lap(\bm A\cdot\bm B)&=\bm A\cdot\lap\bm B-\bm B\cdot\lap\bm A+2\div[(\bm B\cdot\nabla)\bm A+\bm B\times(\curl\bm A)].
    \end{align}
\end{theorem}
...
\begin{theorem}
    ...
    \begin{align}
        \lap(\nabla\psi)&=\nabla(\lap\psi),\\
        \lap(\div\bm A)&=\div(\lap\bm A),\\
        \lap(\curl\bm A)&=\curl(\lap\bm A).
    \end{align}
\end{theorem}
...
\begin{theorem}
    ...
    \begin{align}
        ...
        \lap\psi&=\frac1{H_1H_2H_3}\biggfkh{\pp{q_1}\biggkh{\frac{H_2H_3}{H_1}\pv\psi{q_1}}+\pp{q_2}\biggkh{\frac{H_3H_1}{H_2}\pv\psi{q_2}}+\pp{q_3}\biggkh{\frac{H_1H_2}{H_3}\pv\psi{q_3}}}.
    \end{align}
\end{theorem}
...
\begin{align}
    ...
    \end{vmatrix},\\
    \lap\psi&=\frac1{r^2}\pp r\biggkh{r^2\pv\psi r}+\frac1{r^2\sin\theta}\pp\theta\biggkh{\sin\theta\pv\psi\theta}+\frac1{r^2\sin^2\theta}\pv[2]\psi\phi.
\end{align}
...
\begin{align}
    ...
    \end{vmatrix},\\
    \lap\psi&=\frac1\rho\pp\rho\biggkh{\rho\pv\psi\rho}+\frac1{\rho^2}\pv[2]\psi\phi+\pv[2]\psi z.
\end{align}
...
\begin{corollary}
    ...
    \begin{equation}
        \lap\biggkh{\frac1r}=-\div\biggkh{\frac{\uvec r}{r^2}}=-4\pi\vd(\bm r).
    \end{equation}
\end{corollary}
...
\begin{proof}
    利用$\delta$函数
    \[
        \bm F(\bm r)=\int_V\bm F(\bm r')\vd(\bm r-\bm r')\d V'=-\frac1{4\pi}\int_V\bm F(\bm r')\lap\biggkh{\frac1{\abs{\bm r-\bm r'}}}\d V'.
    \]
