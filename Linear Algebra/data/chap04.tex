...
考虑$\RR^m$中$n$个线性无关的向量$a_1,\ldots,a_n$张成的子空间$\spn(a_1,\ldots,a_n)=\C(A)$，其中$A=[a_1\enspace\cdots\enspace a_n]$。向量$b\in\RR^m$在$\C(A)$上的投影为$p\in\C(A)$
\[
